...
validate: test
	...
	$(VENV)/bin/python -m py_compile api/main.py api/schemas.py api/search_service.py api/search_utils.py app/main.py app/ui/speaker_id_tool.py core/config.py ingestion_pipeline/jobs.py ingestion_pipeline/publisher.py ingestion_pipeline/worker.py ingestion_pipeline/run_pipeline.py ingestion_pipeline/steps/step_04_indexing.py inspect_db.py
